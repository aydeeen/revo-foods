...
$card_1_image_mobile = get_field( 'card_1_image_mobile' ) ?: false;
...
$card_2_image_mobile = get_field( 'card_2_image_mobile' ) ?: false;
...
$card_1_button_target   = ! empty( $card_1_button['target'] ) ? $card_1_button['target'] : '_self';
$card_2_button_target   = ! empty( $card_2_button['target'] ) ? $card_2_button['target'] : '_self';
$card_3_button_1_target = ! empty( $card_3_button_1['target'] ) ? $card_3_button_1['target'] : '_self';
$card_3_button_2_target = ! empty( $card_3_button_2['target'] ) ? $card_3_button_2['target'] : '_self';
$card_4_button_target   = ! empty( $card_4_button['target'] ) ? $card_4_button['target'] : '_self';
?>
	    ...
	    <div class="cell">
            <div class="b-grid-cards__layout">
                <div class="b-grid-cards__card b-grid-cards__card--1"> 
                    ...
                    <a href="<?php echo esc_url( $card_1_button['url'] ); ?>" target="<?php echo esc_attr( $card_1_button_target ); ?>"<?php echo '_blank' === $card_1_button_target ? ' rel="noopener noreferrer"' : ''; ?> class="button">
                ...
                <div class="b-grid-cards__card b-grid-cards__card--2"> 
                    ...
                    <a href="<?php echo esc_url( $card_2_button['url'] ); ?>" target="<?php echo esc_attr( $card_2_button_target ); ?>"<?php echo '_blank' === $card_2_button_target ? ' rel="noopener noreferrer"' : ''; ?> class="button">
                ...
                <div class="b-grid-cards__card b-grid-cards__card--3">
                    ...
                    <div class="">
                        <a href="<?php echo esc_url( $card_3_button_1['url'] ); ?>" target="<?php echo esc_attr( $card_3_button_1_target ); ?>"<?php echo '_blank' === $card_3_button_1_target ? ' rel="noopener noreferrer"' : ''; ?> class="button">
                            <?php echo esc_html( $card_3_button_1['title'] ); ?>
                        </a>
                        <a href="<?php echo esc_url( $card_3_button_2['url'] ); ?>" target="<?php echo esc_attr( $card_3_button_2_target ); ?>"<?php echo '_blank' === $card_3_button_2_target ? ' rel="noopener noreferrer"' : ''; ?> class="button">
                ...
                <div class="b-grid-cards__card b-grid-cards__card--4"> 
                    ...
                    <a href="<?php echo esc_url( $card_4_button['url'] ); ?>" target="<?php echo esc_attr( $card_4_button_target ); ?>"<?php echo '_blank' === $card_4_button_target ? ' rel="noopener noreferrer"' : ''; ?> class="button">
