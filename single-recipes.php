   ...
   <div class="single-recipe__boxes-wrapper">
      ...
      <div class="single-recipe__box-2">
         <div class="single-recipe__box-2-featured-image-wrapper">
            <?php
               // Output the featured image HTML, not URL
               echo get_the_post_thumbnail( get_the_ID(), 'full', ['alt' => esc_attr(get_the_title())] );
            ?>
         </div>
         <?php
            // Category mapping for background and image
            $cat_map = [
               'salmon' => [
                  'bg' => '#E8F4FC',
                  'img' => 'salmon.png',
               ...
               'the-filet-asian-fusion-style' => [
                  'bg' => '#E8F4FC',
                  'img' => 'the-filet-asian-fusion-style.png',
                  'alt' => 'The Filet Asian Fusion Style'
               ],
               'the-filet-pink-pepper-and-lemon' => [
                  'bg' => '#E8F4FC',
                  'img' => 'the-filet-pink-pepper-and-lemon.png',
                  'alt' => 'The Filet Pink Pepper and Lemon'
               ],
               'kraken' => [
                  'bg' => '#E8F4FC',
                  'img' => 'kraken.png',
            ...
            $cat_data = $cat_map['default'];
            foreach ($cat_map as $slug => $data) {
               if ($slug !== 'default' && in_category($slug)) {
                  $cat_data = $data;
                  break;
               }
            }
         ...
         <div class="single-recipe__box-2-bottom-part" style="background: <?php echo esc_attr($cat_data['bg']); ?>;">
            ...
            <?php if ( get_field( 'product_link' ) ) : ?>
               <a href="<?php echo esc_url( get_field( 'product_link' ) ); ?>" class="link">
