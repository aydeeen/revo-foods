	...
	<div class="section__inner grid-x grid-padding-x grid-padding-y">
	   ...
	   <div class="cell medium-6 large-4">
		...
		<div class="cell medium-6 large-4">
			<div>
				...
				<?php if ( $footer_button && $footer_button_text ) : ?>
					<div class="footer__button-wrapper">
						<a href="<?php echo esc_url( $footer_button ); ?>" class="button" target="_blank" rel="noopener noreferrer">
      ...
      <div class="cell medium-12 large-4">
         <div class="footer__col-3">
            <div>
               <h3 class="footer__title footer__title--2"><?php esc_html_e( 'Social Media', 'foundationpress' ); ?></h3>
               <div class="footer__socials-wrapper">
                  <?php if ( have_rows( 'footer_socials', 'option' ) ): ?>
                     <?php while ( have_rows( 'footer_socials', 'option' ) ): the_row();
						...
						?>
							<a href="<?php echo esc_url( $link ); ?>" target="_blank" rel="noopener noreferrer" class="footer__social" aria-label="<?php echo esc_attr( $social_label ); ?>">
               ...
               <div class="margin-top-3">
                  <h3 class="footer__title footer__title--3"><?php esc_html_e( 'Revo Shop', 'foundationpress' ); ?></h3>
                  <div class="button-wrapper">
					 <a href="<?php echo esc_url( 'https://shop-revo-foods.com/' ); ?>" class="button" target="_blank" rel="noopener noreferrer">
						...
						<?php esc_html_e( 'Order Now', 'foundationpress' ); ?>
                     </a>
                  </div>
               </div>
            </div>
...
<button id="back-to-top" type="button" aria-label="<?php esc_attr_e( 'Back to top', 'foundationpress' ); ?>" aria-hidden="true" tabindex="-1">
	<span class="icon-wrapper" aria-hidden="true">
		<img src="<?php fopr_assets_uri(); ?>/images/back-to-top.svg" alt="">
	</span>
</button>
